...
%>
<form:form modelAttribute="adminInfo" action="<%=targetUrl %>" method="get">

<form:hidden path="id"/>
<form:input type="text" path="fullName" placeholder="Enter FullName"/><br/>

<form:input type="email" path="email" placeholder="Enter Email"/><br/>

<form:input type="text" path="mobile" placeholder="Enter Mobile"/><br/>

<form:input type="date" path="dob" placeholder="Enter Date Of Birth"/><br/>
...
<body>
	...
	<div class="profile-container">
		<form:form modelAttribute="adminInfo" action="<%=targetUrl%>"
			method="get">
...
<body>
	...
	<div class="profile-container">
	<form:form modelAttribute="adminInfo" action="<%=targetUrl%>" method="get" onsubmit="return validateForm()">
    <h1>Edit Admin Profile</h1>
...
<script>
    ...
    function validateDOB() {
        ...
        if (age < 23 || (age === 23 && today.getMonth() < selectedDate.getMonth()) || (age === 23 && today.getMonth() === selectedDate.getMonth() && today.getDate() < selectedDate.getDate())) {
            dobError.innerHTML = 'Age must be at least 23 years.';
        } else {
            dobError.innerHTML = '';
        }
    }
    function validateForm() {
       ...
       /*  var today = new Date();
        ...
        if (age < 23 || (age === 23 && today.getMonth() < selectedDate.getMonth()) || (age === 23 && today.getMonth() === selectedDate.getMonth() && today.getDate() < selectedDate.getDate())) {
            document.getElementById('dobError').innerHTML = 'Age must be at least 23 years.';
            return false;
        } else {
