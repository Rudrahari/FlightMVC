...
<body>
	...
	<form action="addUserData" method="get">
...
<body>
    <div class="container">
        <h1>Register User</h1>
        <form action="addUserData" method="get" onsubmit="return validateForm()">
        ...
        <a href="userLogin" class="login-link">Already an existing User? Login here.</a>
    </div>
    ...
    <script>
        document.getElementById("Date").addEventListener("input", function () {
            ...
            if (selectedDate > minDate) {
                alert("Should be atleast 18 years old");
                this.value = "";
            }
        });
