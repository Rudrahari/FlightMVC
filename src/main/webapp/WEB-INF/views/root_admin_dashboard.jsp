...
<h1><a href="displayAdmins">Display Admin List</a></h1>
...
<body>
	...
	<div class="dashboard">
		...
		<div class="dashboard-item">
			<h3>Admins List</h3>
			<a href="displayAdmins">Grant/revoke access</a>
		</div>
		...
		<div class="dashboard-item">
			<h3>Update Published Flight Details</h3>
			<a href="airlines/updateFlights">Update Published Flight Details</a>
		</div>
...
<div class="dashboard-item">
		<h3>Airlines Seat Availability</h3>
		<a href="airlines/updateAirlines">Update Airlines Seat Availability Details</a>
	</div>
<div class="dashboard-item">
	<h3>Update Published Airlines Fare</h3>
	<a href="airlines/flightFare">Update Published Airlines Fare</a>
	</div>
<div class="dashboard-item">
	...
	<div class="dashboard-item">
	<h3>Display All Flights Model</h3>
	<a href="getAllDeletedAirlinesmodel">View All Discontinued Flight Models</a>
	</div>
