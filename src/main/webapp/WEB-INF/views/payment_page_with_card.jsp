...
Card cardForPayments=(Card) session.getAttribute("cardforPayments");
%>
    <form action="generateBookingTickets" method="get" onsubmit="return validateForm()">
        ...
        <select id="cardType" name="cardType" required>
         <option value="<%= cardForPayments.getCardType() %>" selected><%= cardForPayments.getCardType() %></option>
        ...
        <input type="text" id="cardNumber" name="cardNumber" value="<%= cardForPayments.getCardNo() %>" required pattern="[0-9]{13,19}" maxlength="19" placeholder="Enter 13 to 19-digit card number">

        <div class="error" id="cardNumberError"></div>

        <label for="expiryDate">Expiry Date:</label>
        <input type="date" id="expiryDate" name="expiryDate" value="<%= cardForPayments.getExpiryDate() %>" required>
...
%>
    ...
    <form action="generateBookingTickets" method="get" onsubmit="return validateForm()">
        ...
        <label for="expiryDate">Expiry Date:</label>
        <input type="date" id="expiryDate" name="expiryDate" min="<%= tommorowDate  %>" value="<%= cardForPayments.getExpiryDate() %>" required>
